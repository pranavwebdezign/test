...
class Database {
	 ...
	 * @since 4.8.9
	 *
	 * @return array List of tables with their columns.
	 */
	...
	/**
	 * Get all installed AIOSEO tables.
	 *
	 * @since 4.9.4.2
	 *
	 * @return array List of installed AIOSEO table names.
	 */
	public function getAioseoTablesWithColumns() {
		$allTables    = $this->getTablesWithColumns();
		$aioseoTables = [];
		$prefix       = $this->prefix . 'aioseo_';

		foreach ( $allTables as $tableName => $columns ) {
			if ( 0 === strpos( $tableName, $prefix ) ) {
				$aioseoTables[ $tableName ] = $columns;
			}
		}
